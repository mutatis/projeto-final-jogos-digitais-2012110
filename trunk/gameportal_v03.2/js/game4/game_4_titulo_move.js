function Game4Titulo_move(file, tamanho_w, tamanho_h, posicao_x, posicao_y)
{//abre 
        ...
        this.tamanho_w_dst = tamanho_w;
        this.tamanho_h_dst = tamanho_h;
