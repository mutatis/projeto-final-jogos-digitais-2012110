	...
	{			
		switch(this.currentGameScene)
		{
			case this.GAMESCENE.INTRO:
				...
				screen.fillText("GAME10 INTRO", 20, 20);
			break;
			case this.GAMESCENE.LEVEL1:
				//level1.draw();
				screen.font = "20px Comic Sans MS";
				screen.fillStyle="#000000";
				screen.fillText("GAME10 LEVEL1", 20, 20);
			break;
			case this.GAMESCENE.THEEND:
				//theEnd.draw();
				screen.font = "20px Comic Sans MS";
				screen.fillStyle="#000000";
				screen.fillText("GAME10 THEEND", 20, 20);
			break;
			case this.GAMESCENE.GAMEOVER:
				//gameOver.draw();
				screen.font = "20px Comic Sans MS";
				screen.fillStyle="#000000";
				screen.fillText("GAME10 GAMEOVER", 20, 20);
			break;
		}
	}
